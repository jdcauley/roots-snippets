<?php if (is_user_logged_in()) : ?>
     ...
     <a button class="btn pull-right" href="<?php echo wp_logout_url(); ?>">Logout</a>
  
     <?php else : ?>
 
        <form class="form-inline pull-right" name="loginform" id="loginform" action="/wp-login.php" method="post" style="margin: 0px" />
